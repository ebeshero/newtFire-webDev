...
declare variable $MissJames := $mitford//tei:TEI//tei:text//tei:p//*[@ref="#Austen_Jane"];
(: Some "unknown knowns": #Byron, #Scott_Wal, #Austen_Jane, #Napoleon :)
(: Output at http://dxcvm05.psc.edu:8080/exist/rest/db/output/AnnotationTool.html :)
declare variable $siteindexID := doc('si.xml')//@xml:id;
