...
<svg width="100" height="{$totalLetterYears * $stretchFactor + 500}"> <!--add additional space for title -->
   <g transform="translate(30, 100)"> <!-- moving 0,0 to 30,-100 :)-->
      ...
      <line x1="50" y1="0" x2="50" y2="{$totalLetterYears * $stretchFactor}" stroke="#3333ff" stroke-width="3" /> 
        ...
        <circle cx="30" cy="{$i * $stretchFactor}" r="{count($letterDates{contains(.,$minLetterYear + $i)})*2}" stroke="green" fill="blue" stroke-width="4"/>        
