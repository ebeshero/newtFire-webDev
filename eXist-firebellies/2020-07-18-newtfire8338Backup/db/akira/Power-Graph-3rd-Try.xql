...
<svg width="1200" height="900">
    <g transform="translate(200, 500)">
        ...
        <g>
            ...
            <text x="{($pos * $xStretchFactor) + 5}" y="-200"  style="fill: black; stroke: none; font-size: 1em;">{$i}{$treeWalkerMatch}({$count})</text>
...
let $filename := "pcsolar-AkiraPowerGraph-3rd.svg"
let $doc-db-uri := xmldb:store("/db/npp16", $filename, $ThisFileContent)
return $doc-db-uri 
(: Output at http://newtfire.org:8338/exist/rest/db/npp16/pcsolar-AkiraPowerGraph-3rd.svg :) 
