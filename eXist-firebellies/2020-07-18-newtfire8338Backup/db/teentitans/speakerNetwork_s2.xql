...
let $s1Coll := collection('/db/teentitans/season2')
...
let $filename := "speakerNetwork_s2.tsv"
let $doc-db-uri := xmldb:store("/db/teentitans", $filename, $ThisFileContent, "text/plain")
return $doc-db-uri
