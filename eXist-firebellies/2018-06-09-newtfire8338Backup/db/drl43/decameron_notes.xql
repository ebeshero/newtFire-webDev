...
return
 ...
 concat($edp, "&#x9;", (: tab character :) $edgeType, "&#x9;", $edgeWeight, "&#x9;", $peer), " &#10;" (:hard return character :));
 
 let $filename := "decOutput.tsv"
let $doc-db-uri := xmldb:store("/db/drl43/", (:"/db/drl43/" where to save mine :) $filename, $ThisFileContent, "text/plain")
return $doc-db-uri
(: output at :http://dxcvm05.psc.edu:8080/exist/rest/db/queries/op/decOutput.tsv ) "/db/drl43/" where to save mine :)
