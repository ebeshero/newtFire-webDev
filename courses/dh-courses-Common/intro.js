...
var twinkies = document.getElementsByClassName('stuff') 
    for (var i = 0, length = twinkies.length; i < length; i++) {
        document.twinkies[i].style.cssText = "text-decoration: underline; text-decoration-style: wavy;"   
    }
}
