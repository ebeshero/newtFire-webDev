...
<html>
    ...
    <body>
        ...
        <!-- Start of Search Form -->
            ...
            <form name="search"
                action="http://obdurodon.org:8090/rest/db/course/blake/xql/keyword.xql" method="get">
